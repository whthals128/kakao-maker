  ...
  return (
    <main>
      <header className="topbar">
        <a className="brand" href="/" aria-label="Creative Maker 홈"><span className="brand-mark">K</span><b>CREATIVE MAKER · KAKAO</b></a>
        <div className="topbar-meta"><a className="maker-home-link" href="/">전체 메이커</a><i /><span>KAKAO BIZBOARD</span><i /> <span>1029 × 258</span></div>
      </header>
